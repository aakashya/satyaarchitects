  ...
  <div class="container mx-auto px-6">
    ...
    <div class="py-14 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="space-y-5 text-center md:text-left">
        <img src="{{ asset('images/logo/logo2.png') }}" alt="Satya Architects" class="h-16 w-auto object-contain mx-auto md:mx-0" />
        <p class="text-sm leading-relaxed text-white/70 max-w-sm mx-auto md:mx-0">
      ...
      <div class="space-y-5 text-center md:text-left">
        ...
        <div class="space-y-3 text-sm">
          <a href="tel:9717676052" class="group flex items-center justify-center md:justify-start gap-3 text-white/70 transition">
          ...
          <a href="mailto:info@satyaarchitects.com" class="group flex items-center justify-center md:justify-start gap-3 text-white/70 transition">
            <span class="h-9 w-9 rounded-full border border-white/10 bg-white/5 flex items-center justify-center
                         transition group-hover:border-sky-400/50 group-hover:bg-sky-400/10">
    ...
    {{-- Bottom Bar --}}
    <div class="border-t border-white/10 py-6 items-center  justify-between gap-3 text-center">
