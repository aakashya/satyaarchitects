...
<section id="home">
  ...
  <div id="home-hero" class="relative h-screen w-full overflow-hidden flex items-center justify-center">
    ...
    <div class="absolute bottom-10 left-6 md:bottom-16 md:left-16 z-20 w-[340px] sm:w-[420px] md:w-[720px]">
      ...
      <h2 id="hero-heading" class="text-lg sm:text-xl md:text-[22px] font-marcellus  text-white mb-5 drop-shadow
    ...
    <div class="container mx-auto px-6">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center lg:justify-end">
          <div class="w-full max-w-sm md:max-w-md rounded-2xl overflow-hidden">
  ...
  <section class="bg-white py-16">
    <div class="container mx-auto px-6">
      <div class="mb-10 text-center">
        <h2 class="text-xs md:text-sm uppercase tracking-[0.35em] text-slate-500 mb-3 font-raleway">
          Company Overview
        </h2>
        <p class="text-2xl md:text-3xl font-serif font-semibold text-slate-900">
      ...
      <div id="company-map" class="max-w-5xl mx-auto px-4 sm:px-8 relative">
        <svg viewBox="0 0 650 800" preserveAspectRatio="xMidYMid meet" onload="init(evt)" class="w-full h-[420px] max-h-[600px]">
          ...
          <path id="IN-CH" title="Chandigarh" class="land"
          ...
          <path id="IN-LD" title="Lakshadweep" class="land"
...
<script type="text/javascript">
  ...
  var toneClasses = ['map-dark', 'map-light', 'map-dark', 'map-light', 'map-dark'];
    ...
    function showTooltip(evt, mouseovertext) {
        // Position tooltip relative to the SVG, slightly offset from the pointer
        const x = evt.offsetX;
        const y = evt.offsetY;

        tooltip.setAttributeNS(null, "x", x + 6);
        tooltip.setAttributeNS(null, "y", y + 8);
        ...
        tooltip_bg.setAttributeNS(null, "y", y - 4);
